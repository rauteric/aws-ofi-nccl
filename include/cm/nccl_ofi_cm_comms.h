...
public:
	 ...
	 * This returns a cm_r_comm that can be used to create the protocol-specific
	 * communicator
	 */
	...
	void insert_completed_r_comm(nccl_ofi_cm_r_comm *r_comm)
	{
...
private:
	...
	std::deque<nccl_ofi_cm_r_comm *> pending_r_comm;
};
...
public:
	 ...
	 */
	nccl_ofi_cm_r_comm(nccl_ofi_connection_manager *_cm,
