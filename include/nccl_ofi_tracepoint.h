...
#define NCCL_OFI_TRACE_POLL_DURATION(dev, rail, rail_id, max_poll_duration) do { \
	lttng_ust_tracepoint(nccl_ofi_plugin, Poll_cq_duration, dev, rail, rail_id, max_poll_duration); \
} while(0)
