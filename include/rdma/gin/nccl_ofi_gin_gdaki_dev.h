 ...
 * createContext_v14 dispatches on it and refuses anything it cannot build.
 *
 * Version 1 is the efa-dp-direct 0.0.1 layout (efa_cuda_qp_v1 /
 * efa_cuda_cq_v1 in nccl_ofi_gin_gdaki_dev_v1.h). Version 0 is a vestigial
 ...
 *
 * INVARIANT: any change to the QP/CQ byte layout MUST bump this value, add a
 * frozen _vN struct set + builder, AND add a matching case in
 * gdaki_gpu_qp/cq::build(); comp_mask capability bits are additive and never
 * change the layout.
 */
