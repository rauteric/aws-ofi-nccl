...
LTTNG_UST_TRACEPOINT_EVENT(
    ...
    LTTNG_UST_TP_FIELDS(
	    ...
	    lttng_ust_field_integer_hex(uint64_t, rail, (uint64_t)rail)
            lttng_ust_field_integer(int, rail_id, rail_id)
            lttng_ust_field_integer(int64_t, max_duration_ns, max_duration_ns)
            lttng_ust_field_integer(int64_t, max_poll_time_ns, max_poll_time_ns)
